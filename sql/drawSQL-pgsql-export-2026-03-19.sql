...
CREATE INDEX "dealership_empresa_nome_representante_index" ON "dealership"."empresa"("nome_representante");
...
COMMENT ON COLUMN "dealership"."veiculo"."laudo_aprovado" IS 'Indica se o laudo do veículo foi aprovado ou não.';
...
CREATE INDEX "dealership_veiculo_arquivo_veiculo_id_index" ON "dealership"."veiculo_arquivo"("veiculo_id");

CREATE INDEX "dealership_veiculo_arquivo_empresa_id_index" ON "dealership"."veiculo_arquivo"("empresa_id");

CREATE INDEX "dealership_veiculo_arquivo_tipo_arquivo_id_index" ON "dealership"."veiculo_arquivo"("tipo_arquivo_id");
...
ALTER TABLE
    "dealership"."veiculo_arquivo"
ADD
    PRIMARY KEY("id");

COMMENT ON COLUMN "dealership"."veiculo_arquivo"."id" IS 'Chave primária (PK) de identificação do arquivo';

COMMENT ON COLUMN "dealership"."veiculo_arquivo"."veiculo_id" IS 'Chave estrangeira de identificação do veículo (FK).';
...
COMMENT ON COLUMN "dealership"."veiculo_arquivo"."criado_em" IS 'Data e hora da crição do registro na tabela.';
...
ALTER TABLE
    "dealership"."veiculo_arquivo"
ADD
    CONSTRAINT "dealership_veiculo_arquivo_empresa_id_foreign" FOREIGN KEY("empresa_id") REFERENCES "dealership"."empresa"("id");

ALTER TABLE
    "dealership"."veiculo_arquivo"
ADD
    CONSTRAINT "dealership_veiculo_arquivo_tipo_arquivo_id_foreign" FOREIGN KEY("tipo_arquivo_id") REFERENCES "dealership"."dominio"("id");
...
ALTER TABLE
    "dealership"."veiculo_arquivo"
ADD
    CONSTRAINT "dealership_veiculo_arquivo_veiculo_id_foreign" FOREIGN KEY("veiculo_id") REFERENCES "dealership"."veiculo"("id");
...
ALTER TABLE
    "dealership"."veiculo_arquivo"
ADD
    CONSTRAINT "dealership_veiculo_arquivo_criado_por_foreign" FOREIGN KEY("criado_por") REFERENCES "dealership"."usuario"("id");

ALTER TABLE
    "dealership"."veiculo"
ADD
    CONSTRAINT "dealership_veiculo_direcao_veiculo_id_foreign" FOREIGN KEY("direcao_veiculo_id") REFERENCES "dealership"."dominio"("id");
...
ALTER TABLE
    "dealership"."veiculo"
ADD
    CONSTRAINT "dealership_veiculo_vendido_por_foreign" FOREIGN KEY("vendido_por") REFERENCES "dealership"."usuario"("id");
