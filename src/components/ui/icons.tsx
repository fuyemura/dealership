 ...
 *
 * Todos seguem o padrão do design system:
 *   stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"
 *
 * Uso: <IconPlus size={16} className="text-brand-black" />
 */
...
export function IconHandshake({ size = 20, className }: { size?: number; className?: string }) {
  return (
    <svg
      width={size}
      height={size}
